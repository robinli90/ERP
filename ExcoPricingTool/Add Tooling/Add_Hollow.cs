...
{
    public partial class Add_Hollow : Form
    {
        DieType dt = DieType.Hollow;
        ...
        {
            CheckBox refBox = (CheckBox)sender;
            Calculate_Die_Price(true);

            plate.CheckedChanged -= pocket_CheckedChanged;
            mandrel.CheckedChanged -= checkBox1_CheckedChanged;
            backer.CheckedChanged -= backer_CheckedChanged;

            if (refBox.Checked)
            {
                mandrel.Checked = false;
                backer.Checked = false;
            }
        ...
        private void backer_CheckedChanged(object sender, EventArgs e)
        {
            CheckBox refBox = (CheckBox)sender;
            Calculate_Die_Price(true);
