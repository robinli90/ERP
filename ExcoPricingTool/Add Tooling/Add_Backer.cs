...
{
    public partial class Add_Backer : Form
    {
        DieType dt = DieType.Backer;
        ...
        /// <param name="g"></param>
        /// <param name="s"></param>
        public Add_Backer(Main _parent, Point g = new Point(), Size s = new Size(), Support Ref_Support_ = null)
        {
