...
{
    public partial class Add_Bolster : Form
    {
        DieType dt = DieType.Bolster;
        ...
        /// <param name="g"></param>
        /// <param name="s"></param>
        public Add_Bolster(Main _parent, Point g = new Point(), Size s = new Size(), Support Ref_Support_ = null)
        {
            ...
            if (Ref_Support_ != null)
            {
                ...
                cavities.Text = Ref_Support.HoleCount.ToString();
        ...
        {
            baseCharges Ref_Base = parent.baseCharge_List.FirstOrDefault(x => x.Diameter * MetricFactor >= refDia  - (parent.isMetric ? parent.metricTolerance : 0) && x.Thickness * MetricFactor >= refThk  - (parent.isMetric ? parent.metricTolerance : 0) && x.Prefix == parent.Get_Die_Prefix(dt));
