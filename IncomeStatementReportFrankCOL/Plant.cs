...
namespace IncomeStatementReportFrank
{
    public class Plant
    {
        ...
        public void BuildSales()
        {
            ...
            string query = "select bq1grp, bq1titl from cmsdat.fgrp where bq1lvl='B' and (bq1comp='04' or bq1comp like '4%')";
        ...
        public void BuildCostOfSales()
        {
            ...
            ExcoODBC solarsoft = ExcoODBC.Instance;
            solarsoft.Open(Database.CMSDAT);
            string query = "select bq1grp, bq1titl from cmsdat.fgrp where bq1lvl='B' and bq1grp like '501%' and (bq1comp='04' or bq1comp like '4%')";
            OdbcDataReader reader = solarsoft.RunQuery(query);
            while (reader.Read())
            {
                groupNameList.Add(reader["bq1titl"].ToString().Trim());
        ...
        public void BuildDeliverySelling()
        {
            ...
            ExcoODBC solarsoft = ExcoODBC.Instance;
            solarsoft.Open(Database.CMSDAT);
            string query = "select bq1grp, bq1titl from cmsdat.fgrp where bq1lvl='B' and bq1grp like '6DS%' and (bq1comp='04' or bq1comp like '4%')";
            OdbcDataReader reader = solarsoft.RunQuery(query);
            while (reader.Read())
            {
                groupNameList.Add(reader["bq1titl"].ToString().Trim());
        ...
        public void BuildFactoryOverhead()
        {
            ...
            ExcoODBC solarsoft = ExcoODBC.Instance;
            solarsoft.Open(Database.CMSDAT);
            string query = "select bq1grp, bq1titl from cmsdat.fgrp where bq1lvl='B' and bq1grp like '503%' and (bq1comp='04' or bq1comp like '4%')";
            OdbcDataReader reader = solarsoft.RunQuery(query);
            while (reader.Read())
            {
                groupNameList.Add(reader["bq1titl"].ToString().Trim());
        ...
        public void BuildGeneralAdmin()
        {
            ...
            ExcoODBC solarsoft = ExcoODBC.Instance;
            solarsoft.Open(Database.CMSDAT);
            string query = "select bq1grp, bq1titl from cmsdat.fgrp where bq1lvl='B' and bq1grp like '6GA%' and (bq1comp='04' or bq1comp like '4%')";
            OdbcDataReader reader = solarsoft.RunQuery(query);
            while (reader.Read())
            {
                groupNameList.Add(reader["bq1titl"].ToString().Trim());
        ...
        public void BuildOtherExpense()
        {
            ...
            ExcoODBC solarsoft = ExcoODBC.Instance;
            solarsoft.Open(Database.CMSDAT);
            string query = "select bq1grp, bq1titl from cmsdat.fgrp where bq1lvl='B' and bq1grp like '6OT%' and (bq1comp='04' or bq1comp like '4%')";
            OdbcDataReader reader = solarsoft.RunQuery(query);
            while (reader.Read())
            {
                groupNameList.Add(reader["bq1titl"].ToString().Trim());
        ...
        public void BuildDirectLabour()
        {
            ...
            ExcoODBC solarsoft = ExcoODBC.Instance;
            solarsoft.Open(Database.CMSDAT);
            string query = "select bq1grp, bq1titl from cmsdat.fgrp where bq1lvl='B' and bq1grp like '502%' and (bq1comp='04' or bq1comp like '4%')";
            OdbcDataReader reader = solarsoft.RunQuery(query);
            while (reader.Read())
            {
                groupNameList.Add(reader["bq1titl"].ToString().Trim());
